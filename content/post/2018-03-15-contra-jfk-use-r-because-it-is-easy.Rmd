...
<!--![](https://media.giphy.com/media/7GySaKuIzts9q/giphy.gif) -->
...
blogdown::shortcode("tweet", "969586654431404033")
```
...
<!--
- "Coding is easy"; no. metaphor is architect v.s. supervisor, not architect v.s. brick layer
- Signaling; lots of emphasis on avoiding command line bullshittery e.g. Jenny Bryan encourages use of GUIs. Lots of counter-signaling - I use simple tools which leaves me time to think deep thoughts
- Don't use R to signal something; use it to make your life easier
- Switching costs are real. that doesn't mean we shouldn't pay attention tools out there; budding researchers look to experienced ones for guidance - pointing everyone to Stata is not helpful
