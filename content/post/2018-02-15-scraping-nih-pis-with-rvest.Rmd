...
mod = lm(log(adjusted_basic_pay) ~ female + factor(yrs_since_degree), data = pi_opm_fem) 
...
1. We're missing a whole lot of useful information (e.g. productivity, perhaps measured by publication record) 
