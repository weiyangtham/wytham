...
summary: Thoughts on Git + Github for economists
categories:
  - Github
  - Economics
tags:
...
I was lucky to find out about version control relatively early on, which gave me time to experiment with it and figure out how it could be useful to me, but it's easy to see how the Git + Github workflow can seem like more work than it's worth to a newcomer. I'd be interested to know how others have introduced Git + Github in fields where it's not used universally. 